...
export default function LensManager({ lenses, onClose, onUpdate }) {
  const [editingLenses, setEditingLenses] = useState([
    ...lenses.map((l) => ({
      ...l,
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <div style={{ display: "flex", gap: "8px", marginBottom: "8px" }}>
              <input
                value={newLens.name}
                onChange={(e) =>
                  setNewLens((prev) => ({ ...prev, name: e.target.value }))
                }
              ...
              <input
                ...
                value={newLens.color}
                onChange={(e) =>
                  setNewLens((prev) => ({ ...prev, color: e.target.value }))
                }
                style={{
                  width: "50px",
                  height: "38px",
              ...
              <button
                ...
                style={{
                  padding: "8px 12px",
                  background:
                    newLens.name && editingLenses.length < 10
                      ? "#10B981"
                      : "#1E293B",
                  border: "none",
                  borderRadius: "6px",
                ...
                >
                  ...
                  >
                    <input
                      ...
                      value={lens.color}
                      onChange={(e) =>
                        handleUpdateLens(lens.id, "color", e.target.value)
                      }
                      style={{
                        width: "40px",
                        height: "40px",
                    ...
                    <input
                      value={lens.name}
                      onChange={(e) =>
                        handleUpdateLens(lens.id, "name", e.target.value)
                      }
                      style={{
                        flex: 1,
                        padding: "8px",
